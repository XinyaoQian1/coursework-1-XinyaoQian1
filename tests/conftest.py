...
def normal_user_without_birthday():
    user_no_bod = user.User(first_name='Xinyao', last_name='Qian',
...
def normal_user_with_birthday():
    user_with_bod = user.User(first_name='Moon', last_name='Sun',
...
def user_with_wrong_email():
    user_with_wrong_email = user.User(first_name='Fish', last_name='Gomes',
...
def normal_user_with_abnormal_birthday():
    user_with_abnormal_dob = user.User(first_name='Sally', last_name='Day',
...
def user_name_with_number():
    user_name_number = user.User(first_name='2713819', last_name='123123',
